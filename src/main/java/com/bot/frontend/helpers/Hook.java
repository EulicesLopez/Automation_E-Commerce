...
import static com.bot.frontend.baseClass.web.BaseClass.stepFailNoShoot;
...
public class Hook extends Listener {
	...
	private static final String CHROME_DRIVER 	= "/src/main/resources/driver/chrome/88.0/chromedriver.exe";
